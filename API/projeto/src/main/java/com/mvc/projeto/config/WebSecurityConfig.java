package com.mvc.projeto.config;
...
import com.mvc.projeto.security.JWTAutenticacaoFiltro;
import com.mvc.projeto.security.JWTAutorizacaoFiltro;
import com.mvc.projeto.security.JWTUtil;
import com.mvc.projeto.services.CredentialDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_ENDPOINTS_GET = {
			"/livros", "/livros/user/{id}", "/usuarios/email/{email}", "/livros/{id}", "/livros/user/{id}/page"
	};

	private static final String[] PUBLIC_ENDPOINTS_POST = {
		"/autenticacao", "/usuarios/cadastro", "/livros"
	};
